...
export default function CartPage() {
  ...
  const handleCheckout = () => {
    ...
    cartItems.forEach((item, index) => {
      ...
      if (item.slug) {
        lines.push(`🔗 Product: ${SITE_URL}/product/${item.slug}`);
      }
      lines.push("");
    });
        ...
        {showCheckout && (
          <>
            ...
            <motion.div
              ...
              // z-index: above navbar overlay but below modal
              style={{ zIndex: 9998 }}
            />
            ...
            <motion.div
              ...
              className="fixed left-0 right-0 bottom-0 bg-white overflow-hidden flex flex-col"
              style={{
                zIndex: 9999,
                borderRadius: "24px 24px 0 0",
                // Key fix: use env() safe-area for devices with home indicators
                // and leave enough space so the sticky button clears the navbar
                maxHeight: "calc(100dvh - 56px)",   // 56px = approx top safe gap
                // On desktop, switch to centered dialog style
              }}
            >
              {/* Drag handle pill */}
              ...
              <div
                ...
                style={{
                  ...
                  // paddingBottom = sticky button height (68px) + navbar height (~64px) + extra
                  paddingBottom: "148px",
                }}
              >
                {/* Modal Header */}
                <div className="flex items-start justify-between mb-4">
                  ...
                  <button
                    onClick={() => setShowCheckout(false)}
                    className="w-8 h-8 flex items-center justify-center rounded-xl transition-colors flex-shrink-0 mt-1"
                    style={{ background: "#F6FBFB", border: "1px solid #E7EEEE" }}
                  >
                      ...
                      <input
                        ...
                        onFocus={(e) => {
                          ...
                          e.target.style.boxShadow =
                            "0 0 0 3px rgba(79,189,186,0.12)";
                        }}
                        onBlur={(e) => {
              ...
              {/* ── Sticky WhatsApp Button ──
                  Floats above the bottom navbar.
                  paddingBottom uses env(safe-area-inset-bottom) for notch devices,
                  plus 64px extra to clear the app's bottom navbar. ── */}
              <div
